# NVfp4 GEMV Optimization Worker
...
2. **Read `submission.py`** — use the absolute path `/workspace/advisor-mentor/nvfp4_gemv/submission.py`. This is the ONLY file you need to read. Do NOT read `run_eval.py`, `advisor_prompt.md`, or any other file.
